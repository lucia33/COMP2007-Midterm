<%@ Page Title="SchoolEdit" Language="C#" MasterPageFile="~/Default.Master" CodeBehind="Edit.aspx.cs" Inherits="COMP2007_Midterm.Schools.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="COMP2007_Midterm.School" DefaultMode="Edit" DataKeyNames="Id"
            ...
            <EditItemTemplate>
                <fieldset class="form-horizontal">
					...
					<asp:ValidationSummary runat="server" CssClass="alert alert-danger"  />                 
						    ...
						    <asp:DynamicControl Mode="Edit" DataField="CouseID" runat="server" />
