<%@ Page Title="SchoolList" Language="C#" MasterPageFile="~/Default.Master" CodeBehind="Default.aspx.cs" Inherits="COMP2007_Midterm.Schools.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div>
        <asp:ListView id="ListView1" runat="server"
            DataKeyNames="Id" 
			ItemType="COMP2007_Midterm.School"
            SelectMethod="GetData">
            <EmptyDataTemplate>
                There are no entries found for Schools
            </EmptyDataTemplate>
            <LayoutTemplate>
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>
								<asp:LinkButton Text="CouseID" CommandName="Sort" CommandArgument="CouseID" runat="Server" />
							</th>
                            <th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Schools/Details", Item.Id) %>' Text="Details" /> | 
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Schools/Edit", Item.Id) %>' Text="Edit" /> | 
                        <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Schools/Delete", Item.Id) %>' Text="Delete" />
                    </td>
                </tr>
            </ItemTemplate>
        </asp:ListView>
